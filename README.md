...
The researched scope is recorded in `.factory/brief.json`, the original visual system and image provenance in `.factory/design.md`, and release verification in `.factory/handoff.md`.
